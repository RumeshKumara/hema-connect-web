...
export default function Footer() {
  ...
  return (
    ...
    <footer className="mt-8 bg-black px-4 py-8 sm:px-6">
      <div className="mx-auto grid w-full max-w-7xl items-center gap-5 md:grid-cols-[1fr_auto_1fr]">
        ...
        <Link href="/" className="flex items-center gap-4 justify-self-start">
          <span className="grid h-14 w-14 place-items-center rounded-2xl bg-[#efecec] text-red-500 shadow-[0_0_0_8px_rgba(255,255,255,0.1),0_0_34px_10px_rgba(255,255,255,0.18)]">
            <svg
              aria-hidden="true"
              viewBox="0 0 24 24"
              className="h-7 w-7"
          ...
          <span className="text-4xl font-semibold tracking-tight text-[#2b2b2f]">
            HemaFlaw
          </span>
        </Link>

        {/* Centered legal and mission statement text. */}
        <p className="justify-self-center text-center text-[1.35rem] font-medium text-[#3b3b3f]">
